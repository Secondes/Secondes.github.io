		...
		function() {
			...
			i._$0s = 1, i._$4s = 2, i._$42 = 0, i._$62 = function(t, e) {
				...
				for (var o = 0, n = 0; n < e.CHANNEL_COUNT; n++) {
					...
					} else if (s <= 1 2 3 6 4) for (var h="0;" < s; h++) { var l="h" % 2, $="h" 2; a="this.clipContextList[o++];" a.layoutchannelno="n," a.layoutbounds.x=".5" * l, a.layoutbounds.y=".5" $, a.layoutbounds.width=".5," a.layoutbounds.height=".5" } else if (s 3, 3; _._$li("_$6 _$0p mask count : %d", s) }, r.prototype.addclippeddrawdata="function(t," i) e="new" o(t, i); this.clippeddrawcontextlist.push(e) s._$jt="function(t," i, e) r="t" o="e" n="o," s="1" - (1 o) o), _="1" n) n), + (n (2 3) n)) s), (o o)) _), 0, u="3" 0; (r return>= 1) return 1;
				var p = r,
					f = p * p;
			...
			It._$ni = function(t, i, e, r, o, n, s, _, a) {
				...
				return this.x <= 0 1 2="=" this.x && this.y <="this.y" + this.width this.height }, s.prototype.expand="function(t," i) { -="t," * t, i v._$z2="function(t," i, e, r) var o="i._$Q2(t," e), n="t._$vs()," s="t._$Tr();" if (i._$zr(n, s, o), return r[n[0]]; (1="=" o) _="r[n[0]]," a="r[n[1]]," h="s[0];" (a _) | } (2="=" l="r[n[2]]," $="r[n[3]]," u="s[1]," p="_" 0, f="l" ($ l) 0; (f p) (3="=" c="r[n[0]]," d="r[n[1]]," g="r[n[2]]," y="r[n[3]]," m="r[n[4]]," t="r[n[5]]," v="s[2]," (d c) (y g) (t m) (s (4="=" e="r[n[2]]," w="r[n[5]]," x="r[n[6]]," r="r[n[9]]," b="r[n[10]]," (m e) (w (o x) (r d) b) (n (u for (var << o, k="new" float32array(y), y; v++) z="1," o; h++) % ? s[h] : s[h], = 2; k[v]="z" j="0;" j++) w[j]="r[n[j]];" q="0," w[j]; .5 v._$br="function(t," u) (_ h) (l ((1 (p (c h)) (g (v s) (e (i h))) (x (b float32array(u), u; y++) x++) s[x] s[x], g[y]="V" z[h]="r[n[H]];" z[h]; v._$vr="function(t," r, n, i._$zr(h, l, a); w._$jt(f, $); else $;) n[u]="f[c++]," n[u 1]="f[c++]," a) g, d[c] ++c, p, y, f[c] m[c] t[c], c, a[c] i[c] x[c] o[c] r[c] b[c] f[c], tt="o[h[8]]," it="o[h[9]]," et="o[h[10]]," rt="o[h[11]]," ot="o[h[12]]," nt="o[h[13]]," st="o[h[14]]," _t="o[h[15]]," at="l[3]," ht="1" at, lt="ht" $t="ht" ut="ht" pt="ht" ft="ht" ct="ht" dt="ht" gt="ht" yt="at" mt="at" vt="at" h[c] w[c] j[c] q[c] z[c] k[c] tt[c] it[c] et[c] rt[c] ot[c] nt[c] st[c] _t[c], a, float32array(et), et; it++) wt="It," xt="1," a; ot++) l[ot] l[ot], at[it]="xt" rt++) dt[rt]="o[h[Rt]];" bt="0," 1, dt[rt][c], dt[rt][ct]; l.prototype._$ht="function(t," m._$ur="-2," m._$es="500," m._$wb="2," m._$8s="3," m._$52="M._$ES," m._$r2="M._$ES," m._$or="function()" m._$pr="function()" m.prototype.convertclipidforv2_11="function(t)" null="=" t.length , .test(t) (i.push(t.id), m.prototype._$f0="function(t)" this._$gp="t._$nP()," this._$dr="t._$nP()," this._$gs="t._$nP()," this._$qb="t._$6L()," this._$lb="t._$cS()," this._$ms="t._$Tb()," t.getformatversion()>= G._$T7 ? (this.clipID = t._$nP(), this.clipIDList = this.convertClipIDForV2_11(this.clipID)) : this.clipIDList = [], this._$MS(this._$Lb)
				...
				for (var e = this._$Ws.length, r = t, o = 0; o < e; ++o) {
					...
					if (n != Y._$V2) for (;;) {
						...
						var _ = this._$Er[n];
						if (_ <= n || _="=" y._$w0) break; } }, y.prototype.setdrawparam="function(t)" { this.dp_webgl="t" y.prototype.getdrawparam="function()" return k._$0t="function(t)" k._$0t(new _$5(t)) if (!t.exists()) throw new _$ls(t._$3b()); for (var i, e="t.length()," r="new" int8array(e), o="new" _$xs(new _$kb(t), 8192), (i="o.read(r," n, - n))> 0;) n += i;
				return r
			}, k._$C = function(t) {
				var i = null,
					e = null;
...
default = o;
	...
	default;
		...
		this.models.length <= 0="=" 187="=" 191="=" t || (this.models[t].release(i), delete this.models[t], this.models.splice(t, 1)) }, o.prototype.nummodels="function()" { return this.models.length o.prototype.setdrag="function(t," i) for (var e="0;" < this.models.length; e++) this.models[e].setdrag(t, o.prototype.maxscaleevent="function()" $. default.debug_log && console.log("max scale event."); t++) this.models[t].startrandommotion($. default.motion_group_pinch_in, default.priority_normal) o.prototype.minscaleevent="function()" console.log("min default.motion_group_pinch_out, o.prototype.tapevent="function(t," console.log("tapevent view x:" + " y:" i); this.models[e].hittest($. default.hit_area_head, t, ? ($. console.log("tap face."), this.models[e].setrandomexpression()): default.hit_area_body, body. models[" "]"), this.models[e].startrandommotion($. default.motion_group_tap_body, default.priority_normal)) : this.models[e].hittestcustom("head", default.motion_group_flick_head, this.models[e].hittestcustom("body", default.priority_normal)); !0 } function(t, i, e) "use strict"; function r() {} object.defineproperty(i, "__esmodule", value: }), i. default="r;" var o="e(2);" r.prototype.loadbytes="function(t," xmlhttprequest; e.open("get", !0), e.responsetype="arraybuffer" , e.onload="function()" switch (e.status) case 200: i(e.response); break; default: console.error("failed to load (" e.status ") t) e.send(null) r.prototype.loadstring="function(t)" this.loadbytes(t, function(t) }) r.prototype.loadlive2dmodel="function(t," i(e) r.prototype.loadtexture="function(t," e, r) n="new" image; n.crossorigin="Anonymous" n.src="e;" n.onload="function()" o.getcontext)(), s="e.createTexture();" if (!s) generate gl texture name."), -1; t.ispremultipliedalpha() e.pixelstorei(e.unpack_premultiply_alpha_webgl, 1), e.pixelstorei(e.unpack_flip_y_webgl, e.activetexture(e.texture0), e.bindtexture(e.texture_2d, s), e.teximage2d(e.texture_2d, 0, e.rgba, e.unsigned_byte, n), e.texparameteri(e.texture_2d, e.texture_mag_filter, e.linear), e.texture_min_filter, e.linear_mipmap_nearest), e.generatemipmap(e.texture_2d), t.settexture(i, "function"="=" typeof r n.onerror="function()" image r.prototype.jsonparsefrombytes="function(t)" uint8array(t, 3); i="239" =="e[0]" e[1] e[2] string.fromcharcode.apply(null, new 3)) uint8array(t)), json.parse(i) r.prototype.log="function(t)" r(t) t.__esmodule o() n.l2dbasemodel.prototype.constructor.call(this), this.modelhomedir this.modelsetting="null," this.tmpmatrix="[]" _="r(s)," a="e(1)," h="r(a)," l="e(3)," $="r(l);" o.prototype="new" n.l2dbasemodel, o.prototype.load="function(t," this.setupdating(!0), this.setinitialized(!1), i.lastindexof(" _. default; this.modelsetting.loadmodelsetting(i, function() r.modelsetting.getmodelfile(); r.loadmodeldata(t, r.modelsetting.gettexturenum(); i++) ( ^https?:\ \ |^\ i.test(r.modelsetting.gettexturefile(i))) else r.modelsetting.gettexturefile(i); r.loadtexture(i, o, (r.istexloaded) (r.modelsetting.getexpressionnum()> 0) {
								r.expressions = {};
